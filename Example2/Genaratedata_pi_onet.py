...
def generate_train_data(sample_num, device,  p):
    ...
    sample_left      =  ( sample_left[...,: sensor_num1+ sensor_num2],      sample_left[...,-2:-1],sample_left[...,-1:])
    sample_right     =  ( sample_right[...,: sensor_num1+ sensor_num2],     sample_right[...,-2:-1],sample_right[...,-1:])
    sample_interface =  ( sample_interface[...,: sensor_num1+ sensor_num2], sample_interface[...,-1:])
    sample_boundaryl =  ( sample_boundaryl[...,: sensor_num1+ sensor_num2], sample_boundaryl[...,-1:])
    sample_boundaryr =  ( sample_boundaryr[...,:  sensor_num1+ sensor_num2], sample_boundaryr[...,-1:])
