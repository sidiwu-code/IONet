...
class IONet(nn.Module):
    def __init__(self, sensor_up,sensor_down, m=20,actv=nn.Tanh()):
        super(IONet, self).__init__()
        self.actv=actv
        self.b1linear_input = nn.Linear(sensor_up,m)    
        self.b1linear1 =nn.Linear(m,m)
        self.b1linear2 = nn.Linear(m,m)
        self.b1linear3 =nn.Linear(m,m)
        self.b1linear4 = nn.Linear(m,m)

        self.b2linear_input = nn.Linear(sensor_down,m)    
        ...
        self.t2linear_input = nn.Linear(2,m)    
